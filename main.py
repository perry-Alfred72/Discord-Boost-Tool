...
def boost_menu():
    ...
    while True:
        ...
        if choice.lower() == 'c':
            ...
            print(Fore.GREEN + "Invalid choice. Please enter C to continue or X to close." + Style.RESET_ALL)
...
def menu():
    ...
    invite = input(f"{Style.BRIGHT}{Fore.GREEN}[+]{Fore.CYAN} Invite: ")
    if ".gg/" in invite:
    ...
    try:
        months = int(input(f"{Style.BRIGHT}{Fore.GREEN}[+]{Fore.CYAN} Months: "))
    except:
    ...
    try:
        amount = int(input(f"{Style.BRIGHT}{Fore.GREEN}[+] {Fore.CYAN}Amount: "))
    except:
    ...
    nick = input(f"{Style.BRIGHT}{Fore.GREEN}[+] {Fore.CYAN}Nickname: ")
    go = time.time()
